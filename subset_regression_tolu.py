...
# Filtered August 2024 graph for confusion matrix
...
# Calculate the confusion matrix based on 'Actual Fire' and 'Predicted Fire' columns
...
feature_index = list(X_train.columns).index('Fuel_119')
print(feature_index)
csv_path = os.path.join(base_dir, "Model Analysis/Graphs/XGB_Fuel_119_avg_probabilities.csv")
...
feature_index = list(X_train.columns).index('temp_2m')
print(feature_index)
csv_path = os.path.join(base_dir, "Model Analysis/Graphs/XGB_temp_2m_avg_probabilities.csv")
...
# Fuel Type 118
feature_index = list(X_train.columns).index('Fuel_118')
print(feature_index)
csv_path = os.path.join(base_dir, "Model Analysis/Graphs/XGB_Fuel_118_avg_probabilities.csv")

df_effect = plot_variable_effect(
    rf_model=xgb,
    X=X_train,
    feature_index=feature_index,
    feature_name="Fuel Type 118",
    save_csv_path=csv_path
)